...
tmux send-keys -t training:0.0 'export TORCH_USE_CUDA_DSA=1; export PYTHONUNBUFFERED=1; /home/arika/IsaacLab/isaaclab.sh -p arcproLab/scripts/train_policy.py --num_envs 8 --headless --total_timesteps 5000000 --enable_cameras | tee -a logs/curriculum_phase1.log' C-m
