...
- [x] **Phase 15: 15-hd-vision-resnet** - Research into ResNet-18 vs Custom CNN and uint8 optimization.
- [ ] **Phase 15: 15-mastery-curriculum** - **ACTIVE** - Single-Agent Lane-Following Mastery. Achieve full-lap capability (6000+ steps) using a dynamic boundary curriculum and memory-optimized HD vision.
    - [x] 15-01-PLAN.md — Unified Mastery Curriculum (ResNet-18, Windowed Search, 32-Envs)
...
- [ ] **Phase 16: 16-marl-transition** - Refactor singletons to vectorized managers and establish multi-agent scene config.
