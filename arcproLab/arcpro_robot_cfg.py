...
class ArcProRobotCfg(ArticulationCfg):
    ...
    spawn: sim_utils.UsdFileCfg = sim_utils.UsdFileCfg(
        ...
        usd_path=os.path.join(os.path.dirname(__file__), "assets", "robot", "F1Tenth_Metric_Fixed.usd"),
        scale=(1.0, 1.0, 1.0), 
        ...
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            ...
            max_angular_velocity=1000.0,  # Reverted back to 1000.0 to prevent crippling wheel speed
